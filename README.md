...
A server-side request causes the whole page to refresh. This is because a GET request is sent to the server which responds with a new document, completely discarding the old page altogether.
...
Axios, Fetch, jQuery $.ajax, Superagent
